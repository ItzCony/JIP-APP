...
ZAKLADNI_PRAVA = {
    ...
    'cenopripad_zadatel_ovozel': {'kategorie': 'Modul Cenopřípad', 'nazev': 'Žadatel – Kontrola cen OVOZEL', 'popis': 'KONTROLA CEN OVOZEL — Vkládá soubor „OZ změny PC“ ke kontrole proti nahraným datům OVOZEL a vidí jen své kontroly. NEMŮŽE nahrávat sestavu Sklad 6, exportovat kontrolní sestavu ani mazat případy.', 'ikona': 'sell'},
    'cenopripad_office_ovozel':  {'kategorie': 'Modul Cenopřípad', 'nazev': 'Office nákup – Kontrola cen OVOZEL', 'popis': 'KONTROLA CEN OVOZEL — Nahrává týdenní sestavu Sklad 6 (data OVOZEL), vkládá soubory ke kontrole, vidí všechny kontroly a exportuje kontrolní sestavu. Chodí mu e-mail s výsledkem každé kontroly. Mazat případy smí až Správce.', 'ikona': 'task_alt'},
