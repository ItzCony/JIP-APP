...
ZAKLADNI_PRAVA = {
    ...
    'cenopripad_zadatel_nakup':  {'kategorie': 'Modul Cenopřípad', 'nazev': 'Žadatel nákup',  'popis': 'Podává žádosti o kontrolu letákových cen (dlaždice leták/sklad6/mimoleták/paima) a vidí jen své tikety a jejich stavy. Nevidí OP ani marže v %. KONTROLA CEN OVOZEL: vkládá soubory „OZ změny PC“ ke kontrole a vidí jen své kontroly; nenahrává sestavu Sklad 6, neexportuje ani nemaže.', 'ikona': 'sell'},
    ...
    'cenopripad_office_nakup':   {'kategorie': 'Modul Cenopřípad', 'nazev': 'Office nákup',   'popis': 'Uzavírá a dotahuje schválené nákupní případy do nastavení a může je stornovat s uvedením důvodu. Rozhoduje se pouze podle verdiktu aplikace — NEvidí OP ani marže v %. KONTROLA CEN OVOZEL: nahrává týdenní sestavu Sklad 6, zadává kontroly, vidí všechny a exportuje kontrolní sestavu; chodí mu e-mail s výsledkem každé kontroly (mazat případy smí až Správce).', 'ikona': 'task_alt'},
